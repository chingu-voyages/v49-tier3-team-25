// Change a tags to Link when using react router
  ...
  return (
    <footer className="mt-auto w-full bg-neutral-950">
      <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <div className="pb-5">
          <a
            className="flex-none text-xl font-semibold text-white pb-5"
            href="/"
            aria-label="Brand"
          >
            Brand
        ...
        <div className="pt-5 mt-5 border-t border-gray-200">
          <div className="flex justify-centre items-center flex-col gap-2">
            <p className="text-sm text-gray-400">
              <a href="https://github.com/chingu-voyages/v49-tier3-team-25">
            ...
            <p className="text-xs text-gray-400">
              ...
              ,
              <a
                href="https://www.figma.com/community/file/1271751279140741643/clicon-ecommerce-marketplace-website-figma-template-community?searchSessionId=lw5puqu4-tt7lc69ffa"
                className="underline"
              >
                Templatecookie
              </a>
              ,
              <a
                href="https://www.figma.com/community/file/1307034280604606485/admin-dashboard-e-commerce-design"
                className="underline"
              >
                {" "}
                Shristi Singh
              ...
              ,
              <a
                href="https://www.figma.com/community/file/1232451162003418746/evaly-e-commerce-dashboard"
                className="underline"
              >
                {" "}
