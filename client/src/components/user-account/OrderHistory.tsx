...
export default function OrderHistory() {
  ...
  const orders: Transaction[] = useAppSelector(
  ...
  const getTotal = (items: Transaction[]) => {
    return items.reduce((acc, curr) => {
      return (acc = acc + curr.book.salePrice * curr.quantity);
    }, 10);
  };
                      ...
                      <td className="size-px whitespace-nowrap">
                        <div className="pe-6 py-2">
                          <Link
                            ...
                            to={`/account/orders/${transaction._id}`}
                            state={{
                              state: transaction,
                              total: getTotal(transaction.items),
                            }}
                          >
                            #{transaction._id}
                          </Link>
                      ...
                      <td className="size-px whitespace-nowrap">
                        <div className="px-6 py-2">
                          <span className="text-sm text-gray-600 dark:text-neutral-400">
                            {/* @ts-expect-error - dont know how to fix error */}
